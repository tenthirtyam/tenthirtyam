...
<!-- dark mode -->
<img src="https://github.com/tenthirtyam/.github/blob/main/docs/images/logo-dark.png?raw=true#gh-dark-mode-only" alt="tenthirtyam"/>
<!-- light mode -->
<img src="https://github.com/tenthirtyam/.github/blob/main/docs/images/logo-light.png?raw=true#gh-light-mode-only" alt="tenthirtyam"/>

Ryan works at the intersection of customer success, product engineering, and open source, helping
organizations adopt cloud platforms with confidence. His career has moved between hands-on engineering
leadership and direct customer engagement, but the through-line has always been the same: turning
complex problems into practical, scalable systems that real teams can actually use. He maintains and
contributes to open source projects across the Terraform, Packer, Ansible, Go, and PowerShell
ecosystems, and is a two-time HashiCorp Core Contributor and long-standing VMware vExpert (2013–2026).

He writes at <a href="https://tenthirtyam.org">tenthirtyam.org</a> <img src="icons/external-link.svg" width="13" height="13" alt="External Link"> -
a collection of hypertext dispatches on technology, personal interests, and the occasional side quest.
The writing tends to follow automation, open source craft, and the small decisions that shape
how developers actually get things done. He publishes because someone else might be stuck on the same
thing. Occasionally, something more personal slips in - a song, a story, or something he noticed on a
long run.

## <img src="icons/fire-light.svg#gh-light-mode-only" width="20" height="20"><img src="icons/fire-dark.svg#gh-dark-mode-only" width="20" height="20">&nbsp;&nbsp;Tech Stack
...
<a href="https://vexpert.vmware.com/directory/1250" title="Verify on VMware vExpert"><img src="icons/verify.svg" width="13" height="13" title="Verify"></a>&nbsp;VMware vExpert 2013-2026
...
## <img src="icons/fire-light.svg#gh-light-mode-only" width="20" height="20" alt="Pull Request"><img src="icons/fire-dark.svg#gh-dark-mode-only" width="20" height="20" alt="Pull Request">&nbsp;&nbsp;Web Projects

<a href="https://nolanjjohnson.com"><img src="icons/external-link.svg" width="13" height="13" alt="External Link"></a>&nbsp;Nolan J. Johnson (<a href="https://nolanjjohnson.com">`nolanjjohnson.com`</a>). <br/>&nbsp;&nbsp;&nbsp;&nbsp;Developed with ❤️ for my son. <br/>&nbsp;&nbsp;&nbsp;&nbsp;Portfolio built with React, TypeScript, Tailwind CSS, and Vite. <br/>&nbsp;&nbsp;&nbsp;&nbsp;Uses Vercel serverless functions for the API and deployed on Vercel with GitHub CI/CD.

<a href="https://parkernjohnson.com"><img src="icons/external-link.svg" width="13" height="13" alt="External Link"></a>&nbsp;_Parker N. Johnson_ (<a href="https://parkernjohnson.com">`parkernjohnson.com`</a>). <br/>&nbsp;&nbsp;&nbsp;&nbsp;Developed with ❤️ for my son. <br/>&nbsp;&nbsp;&nbsp;&nbsp;Portfolio built with React, TypeScript, Tailwind CSS, and Vite. <br/>&nbsp;&nbsp;&nbsp;&nbsp;Uses Vercel serverless functions for the API and deployed on Vercel with GitHub CI/CD.

<a href="https://shizzlesproductions.com"><img src="icons/external-link.svg" width="13" height="13" alt="External Link"></a>&nbsp;_The 39 Steps_ presented by Shizzles Productions (<a href="https://shizzlesproductions.com">`shizzlesproductions.com`</a>). <br/>&nbsp;&nbsp;&nbsp;&nbsp;Developed website for the Shizzles Productions presentation of _The 39 Steps_.<br/>&nbsp;&nbsp;&nbsp;&nbsp;Portfolio built with React, TypeScript, Tailwind CSS, and Vite. <br/>&nbsp;&nbsp;&nbsp;&nbsp;Uses Vercel serverless functions for the API and deployed on Vercel with GitHub CI/CD.
...
<a href="https://github.com/tenthirtyam/"><img src="icons/external-link.svg" width="13" height="13" alt="External Link"></a>&nbsp;Packer Plugin for JFrog Artifactory (In Development), Creator and Maintainer
...
<img src="icons/fire-light.svg#gh-light-mode-only" width="13" height="14"><img src="icons/fire-dark.svg#gh-dark-mode-only" width="13" height="13"> Ansible Collection for VMware Cloud Foundation 9, Developer and Maintainer<br/>
&nbsp;&nbsp;&nbsp; Developed for a financial customer in my Customer Success role at Broadcom.

---

<sub>Icons are <a href="https://github.com/primer/octicons"><img src="icons/external-link.svg" width="11" height="11" alt="External Link"></a>&nbsp;<a href="https://github.com/primer/octicons">GitHub Octicons</a> by <a href="https://github.com/primer">GitHub Primer</a>, licensed under the <a href="https://github.com/primer/octicons/blob/main/LICENSE">MIT License</a>.</sub>
