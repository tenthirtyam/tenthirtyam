...
<a href="https://nolanjjohnson.com"><img src="icons/external-link.svg" width="13" height="13" alt="External Link"></a>&nbsp;Nolan J. Johnson (<a href="https://nolanjjohnson.com">`nolanjjohnson.com`</a>). <br/>&nbsp;&nbsp;&nbsp;&nbsp;Developed with ❤️ for my son. <br/>&nbsp;&nbsp;&nbsp;&nbsp;Actor portfolio built with React, TypeScript, Tailwind CSS, and Vite. <br/>&nbsp;&nbsp;&nbsp;&nbsp;Uses Vercel serverless functions for the API and deployed on Vercel with GitHub CI/CD.
